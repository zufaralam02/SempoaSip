...
import com.zufaralam02.sempoasip.Student.Journey.Adapters.AdapterStageJourney;
...
public class StageJourney extends BaseActivitySempoa {
    //    FragmentPagerAdapter fragmentPagerAdapter;
    TextView tvCountDownTimer, tvTimeResult;
    Button btnOne, btnTwo, btnThree, btnFour, btnFive, btnSix, btnSeven, btnEight, btnNine, btnZero,
            btnStageNext, btnPlayAgain, btnBackToMap, btnDelete;
    //    Button btnStageBack;
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listStage.add(new String[]{"1", "2", "3", "4", "5"});
        listStage.add(new String[]{"1", "2", "3", "4", "5"});
        listStage.add(new String[]{"1", "2", "3", "4", "5"});
...
//                String edtStage = edtStageJourney.getText().toString();
//                if (edtStage.isEmpty()) {
//
//                } else {
                viewPager.setCurrentItem(viewPager.getCurrentItem() + 1, true);
                edtStageJourney.setText("");
//                }
            }
        });
...
//                    btnStageBack.setVisibility(View.VISIBLE);
        ...
        edtStageJourney.setInputType(InputType.TYPE_NULL);
