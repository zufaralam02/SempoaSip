...
import com.zufaralam02.sempoasip.Student.Journey.Adapters.AdapterNewStageJourney;
import com.zufaralam02.sempoasip.Student.Journey.Fragments.FragmentNewStage;
...
public class NewStageJourney extends BaseActivitySempoa {
    ...
    Button btnOneNew, btnTwoNew, btnThreeNew, btnFourNew, btnFiveNew, btnSixNew, btnSevenNew, btnEightNew, btnNineNew, btnZeroNew,
            btnStageNextNew, btnPlayAgain, btnBackToMap, btnDeleteNew;
    //    Button btnStageBackNew;
...
//        btnStageBackNew = (Button) findViewById(R.id.btnStageBackNew);
        ...
        edtStageJourneyNew.setInputType(InputType.TYPE_NULL);
...
//        listNewStage.add(new String[]{"1", "3", "5", "7", "9"});
        ...
        FragmentNewStage fragmentNewStage1 = FragmentNewStage.newInstance(1, new String[]{"1", "3", "5", "7", "9"});
        fragmentNewStage1.setParent(this);
        listFragment.add(fragmentNewStage1);

        FragmentNewStage fragmentNewStage2 = FragmentNewStage.newInstance(2, new String[]{"2", "4", "6", "8", "10"});
...
//                viewPagerNew.setCurrentItem(viewPagerNew.getCurrentItem() + 1);
        ...
        viewPagerNew.setOnTouchListener(new View.OnTouchListener() {
            @Override
